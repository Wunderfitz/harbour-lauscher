...
// Body copy for AboutPage: page margins, wrapped, dimmed against the section
// headers. Nine paragraphs of it, so it is a component rather than nine copies
// of the same five properties.
Label {
