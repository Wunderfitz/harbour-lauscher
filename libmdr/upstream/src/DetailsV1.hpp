...
namespace mdr
{
    ...
    inline bool SupportsFeature(const DetailsV1& state, MDRFeature feature)
    {
        ...
        case MDR_FEATURE_BATTERY_LEFT_RIGHT: return state.mSupport.contains(F::LEFT_RIGHT_BATTERY_LEVEL);
        case MDR_FEATURE_BATTERY_CASE: return state.mSupport.contains(F::CRADLE_BATTERY_LEVEL);
